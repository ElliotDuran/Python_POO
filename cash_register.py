...
class CashRegister():
    ...
    def __lt__(self, other): 
        """ This method return the list from the highest to the lowest. """
        return self.total() > other.total()

    # def __gt__(self, other):
    #     """ This method return the list from the lowest to the highest. """
    #     return self.total() > other.total()
...
if __name__ == "__main__":
    ...
    c5 = CashRegister("Cash register 05", 13, 9, 14)    # $18.9
